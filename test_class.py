...
class Samurai:
    def attack(self):
        return print("Basic Attack")
    
class RedSamurai(Samurai): # inherit Samurai class ---> reuses all instances but can also modify them
    def attack(self):
        return print("Red attack uwu") # modify basic attack print ---> its own special category

class BlueSamurai(Samurai):
    def attack(self):
        return print("BLUE ATTACK SUNG JINWOO")

# create objects 
samurai1 = Samurai()
red_samurai = RedSamurai()
blue_samurai = BlueSamurai()
